...
theory, locked at v5.3.3) plus a growing set of **application papers** that put the
...
(Files 0–5) is frozen at v5.3.3 so application papers have a stable base; a v6 consolidation
...
- The foundation set is frozen at v5.3.3. Changes to foundation files are errata-level unless
