...
- [LITERATURE.md](LITERATURE.md) — triangulated related-work map with per-reference status labels and the novelty verdict (no directly matching prior result found in the scoped literature pass).
