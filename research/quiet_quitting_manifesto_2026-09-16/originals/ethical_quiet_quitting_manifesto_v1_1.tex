...
\hypersetup{
  ...
  pdfauthor={Leah},
  pdfsubject={Repair first; prevent acute constraint collapse; withdraw honestly when repair fails},
  pdfkeywords={quiet quitting, ethics, work, labor, management, boundaries, overload, human factors, acute constraint collapse}
}
...
\vspace{0.2em}
{\sffamily\color{ManifestGray}August 14, 2026 \quad Version 1.1\par}
\vspace{0.55in}
\end{titlepage}
