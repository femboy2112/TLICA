...
The model so far is structural and long-term. It explains how repeated closure of communicable and actionable pathways can eventually produce withdrawal: the worker speaks, proposes, compensates, and waits, but the connection between action and meaningful future outcome disappears. When the institution has also folded unowned excess into the job, quiet quitting proper is the long-horizon response: withdrawal of that excess after meaningful correction pathways close.
