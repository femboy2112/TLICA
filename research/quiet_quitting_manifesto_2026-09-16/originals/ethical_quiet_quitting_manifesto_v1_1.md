...
*Conceptual provenance:* Developed from Leah's TLICA work on agency, semantic interoperability, configurational action, and the separation of acts, outcomes, cascades, responsibility, and accountability, together with lived analysis of institutional work, chronic understaffing, and the acute constraint-collapse response named here as the fuck-it factor.
