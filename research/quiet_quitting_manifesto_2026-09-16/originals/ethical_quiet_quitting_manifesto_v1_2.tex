...
\hypersetup{
  ...
  pdfauthor={Leah},
  pdfsubject={Repair first; recognize constrained exit; prevent acute constraint collapse; withdraw honestly when repair fails},
  pdfkeywords={quiet quitting, ethics, work, labor, management, boundaries, constrained exit, economic coercion, live options, overload, human factors, acute constraint collapse}
}
...
\vspace{0.2em}
{\sffamily\color{ManifestGray}August 15, 2026 \quad Version 1.2\par}
\vspace{0.55in}
\end{titlepage}
...
chronic understaffing, and the acute constraint-collapse response named
here as the fuck-it factor.
