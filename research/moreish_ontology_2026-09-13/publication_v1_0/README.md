...
- `AUDIT_2026-09-19_POST_CLAUDE.md` — independent post-Claude publication audit: current paper status, narrowed novelty ledger, live defects, and remaining gates to v1.0.
