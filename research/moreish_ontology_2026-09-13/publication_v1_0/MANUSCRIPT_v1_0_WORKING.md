...
Retrospection has one signature hazard — a tidy story is easy to build after the fact — so the paper treats **redemptive over-coherence** as a standing falsification risk (Lakatos, 1970): the reconstruction loses if records, remembered counterexamples, or a less flattering rival fit the episodes better, and a life that turned out well never proves the earlier path was necessary, deserved, or providential.
