...
*[Author name, affiliation, ORCID, corresponding-author details, funding, competing-interests, and acknowledgments removed for double-blind review; supplied on the separate title page.]*
...
These are among the questions a broader theoretical project of the author's — named in the non-anonymized submission materials — attempts to formalize.
...
$$
\text{the framework says it}
\to
\text{therefore it happened}.
$$

This paper should stand even if that framework later turns out to be wrong.
