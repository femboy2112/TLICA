...
\to
\text{look for it in lived reality}
\to
\text{notice recurrence}
\to
\text{internalize}.
\]
...
\not\Rightarrow
\text{the broadest policy built from it should govern my life}.
\]
...
The central mathematical structure is elementary.
