# The Two-Layer Identity-Correlation Architecture (v5.4.1)

## Reading Guide and Overview

---

**Status:** Foundation document set, v5.4.1
**Supersedes:** v5.4.0 (corrective patch to the dynamical apparatus — profile-space typing, the ρ-metric gradient convention, the death/non-equilibrium-steady-state distinction, Mode B as self-sourced imprinting, and slack scoping; see Section 13.4, File 5); v5.3.3 (which added the dynamical apparatus — Sections 8.9–8.11, File 3, and the dynamical commitment in Section 2.10, File 1); v5.0 unified document; integrates v5.1 patches and v5.2 additions and the temporal phenomenology application
